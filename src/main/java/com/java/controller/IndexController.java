...
public class IndexController {
	...
	public void addImage(@RequestParam("upfile") MultipartFile file , HttpServletRequest request, HttpServletResponse response)throws Exception {
		...
		if (!file.isEmpty()) {
			try {
				...
				//通过流的方式上传到七牛，并返回图片路径
				path = new QinNiuUtil().uploadFile(in, null);
				//请求结束后，根据自身需求
				String data ="{\"state\":\"SUCCESS\",\"url\":\""+path+"\"}";
